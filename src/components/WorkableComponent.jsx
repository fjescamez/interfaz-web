            ...
            <div className="workableItem">
                ...
                <div className="workableBody">
                    <div className="workableInfo">
                        ...
                        <p><span className="bold">Actual</span> <span><span className={isTecnico ? "hover" : ""} onClick={() => window.open(whitepaperUrl, "_blank")}>{whitepaper_name}</span><span> - {nodeHistory[nodeHistory.length - 1]?.node_name}</span></span></p>
